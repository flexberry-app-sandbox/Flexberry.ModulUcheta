...
export let Model = Mixin.create({
  ...
  оказУсл: DS.hasMany('i-i-s-modul-ucheta-оказ-услуг', { inverse: 'расчетОстВрем', async: false })
});
...
export let ValidationRules = {
  ...
  оказУсл: {
    descriptionKey: 'models.i-i-s-modul-ucheta-расчет-ост-врем.validations.оказУсл.__caption__',
    validators: [
      validator('ds-error'),
      validator('has-many'),
    ],
...
export let defineProjections = function (modelClass) {
  modelClass.defineProjection('РасчетОстВремE', 'i-i-s-modul-ucheta-расчет-ост-врем', {
    ...
    оказУсл: hasMany('i-i-s-modul-ucheta-оказ-услуг', 'Оказанные услуги', {
