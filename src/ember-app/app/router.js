...
Router.map(function () {
  ...
  this.route('i-i-s-modul-ucheta-длительность-l');
  this.route('i-i-s-modul-ucheta-длительность-e',
  { path: 'i-i-s-modul-ucheta-длительность-e/:id' });
  this.route('i-i-s-modul-ucheta-длительность-e.new',
  { path: 'i-i-s-modul-ucheta-длительность-e/new' });
  ...
  this.route('i-i-s-modul-ucheta-затр-время-l');
  this.route('i-i-s-modul-ucheta-затр-время-e',
  { path: 'i-i-s-modul-ucheta-затр-время-e/:id' });
  this.route('i-i-s-modul-ucheta-затр-время-e.new',
  { path: 'i-i-s-modul-ucheta-затр-время-e/new' });
