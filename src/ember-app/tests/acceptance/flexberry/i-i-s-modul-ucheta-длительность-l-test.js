...
moduleForAcceptance('[AGAT] Acceptance | i i s modul ucheta длительность l');

test('testing i-i-s-modul-ucheta-длительность-l', function(assert) {
  visit('/i-i-s-modul-ucheta-длительность-l');
