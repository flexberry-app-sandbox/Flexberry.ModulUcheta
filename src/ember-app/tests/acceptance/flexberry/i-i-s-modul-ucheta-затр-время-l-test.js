...
moduleForAcceptance('[AGAT] Acceptance | i i s modul ucheta затр время l');

test('testing i-i-s-modul-ucheta-затр-время-l', function(assert) {
  visit('/i-i-s-modul-ucheta-затр-время-l');
