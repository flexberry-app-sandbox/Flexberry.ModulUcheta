...
namespace IIS.Modul_ucheta_
{
    ...
    [View("ДоговорE", new string[] {
            ...
            "Длительность.Длительность as \'Длительность\'",
            ...
            "Клиент as \'Фамилия клиент\'",
            "Клиент.Имя as \'Имя клиент\'",
            "Клиент.Отчество as \'Отчество клиент\'"})]
    ...
    public class Договор : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Modul_ucheta_.Статус fСтатус;
        
        private IIS.Modul_ucheta_.ТипДоговора fТип;
        
        private int fСтоимость;
        
        private IIS.Modul_ucheta_.Клиент fКлиент;
        
        private IIS.Modul_ucheta_.Длительность fДлительность;
        
        private IIS.Modul_ucheta_.ДирОтдПоРабСКл fДирОтдПоРабСКл;
        ...
        public virtual IIS.Modul_ucheta_.Статус Статус
        {
            get
            {
                ...
                IIS.Modul_ucheta_.Статус result = this.fСтатус;
        ...
        public virtual IIS.Modul_ucheta_.ТипДоговора Тип
        {
            get
            {
                ...
                IIS.Modul_ucheta_.ТипДоговора result = this.fТип;
        ...
        [PropertyStorage(new string[] {
                "ДирОтдПоРабСКл"})]
        [NotNull()]
        public virtual IIS.Modul_ucheta_.ДирОтдПоРабСКл ДирОтдПоРабСКл
        {
            get
            {
                ...
                IIS.Modul_ucheta_.ДирОтдПоРабСКл result = this.fДирОтдПоРабСКл;
        ...
        [PropertyStorage(new string[] {
                "Длительность"})]
        [NotNull()]
        public virtual IIS.Modul_ucheta_.Длительность Длительность
        {
            get
            {
                ...
                IIS.Modul_ucheta_.Длительность result = this.fДлительность;
        ...
        [PropertyStorage(new string[] {
                "Клиент"})]
        [NotNull()]
        public virtual IIS.Modul_ucheta_.Клиент Клиент
        {
            get
            {
                ...
                IIS.Modul_ucheta_.Клиент result = this.fКлиент;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ДоговорE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДоговорE", typeof(IIS.Modul_ucheta_.Договор));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ДоговорL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДоговорL", typeof(IIS.Modul_ucheta_.Договор));
                }
            }
        }
    }
