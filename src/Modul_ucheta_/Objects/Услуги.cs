...
namespace IIS.Modul_ucheta_
{
    ...
    [MasterViewDefineAttribute("УслугиE", "ЗатрВремя", ICSSoft.STORMNET.LookupTypeEnum.Standard, "", "Время")]
    [View("УслугиL", new string[] {
            "Наименование as \'Наименование\'",
            "ЗатрВремя.Время as \'Время\'"})]
    public class Услуги : ICSSoft.STORMNET.DataObject
    {
        
        private IIS.Modul_ucheta_.Услуга fНаименование;
        
        private IIS.Modul_ucheta_.ЗатрВремя fЗатрВремя;
        ...
        public virtual IIS.Modul_ucheta_.Услуга Наименование
        {
            get
            {
                ...
                IIS.Modul_ucheta_.Услуга result = this.fНаименование;
        ...
        [PropertyStorage(new string[] {
                "ЗатрВремя"})]
        [NotNull()]
        public virtual IIS.Modul_ucheta_.ЗатрВремя ЗатрВремя
        {
            get
            {
                ...
                IIS.Modul_ucheta_.ЗатрВремя result = this.fЗатрВремя;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПереченьУслугE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПереченьУслугE", typeof(IIS.Modul_ucheta_.Услуги));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ПереченьУслугL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПереченьУслугL", typeof(IIS.Modul_ucheta_.Услуги));
                }
            }
            ...
            public static ICSSoft.STORMNET.View УслугиE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("УслугиE", typeof(IIS.Modul_ucheta_.Услуги));
                }
            }
            ...
            public static ICSSoft.STORMNET.View УслугиL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("УслугиL", typeof(IIS.Modul_ucheta_.Услуги));
                }
            }
        }
    }
